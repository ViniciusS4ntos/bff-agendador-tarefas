...
public class CronService {
    ...
    public void BuscaTarefasProximaHora() {
        ...
        log.info("Iniciada a buscar de tarefas");

        //                          pegar a hora atual e soma + 1 hora
        LocalDateTime horaFutura = LocalDateTime.now().plusHours(1);
        LocalDateTime horaFuturaMaisCinco = LocalDateTime.now().plusHours(1).plusMinutes(30);
        ...
        log.info("Finalizada a buscar e notificacao de tarefas");
